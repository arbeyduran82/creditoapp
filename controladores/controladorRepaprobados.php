...
class PDF extends FPDF
{
    function Header() 
    {
        ...
        $this->Cell(80,85,'CREDITOS APROBADOS',0,0,'C');
        $this->Ln(55);
        $this->SetFont('times','B','13');
        $this->Cell(1);
        $this->Cell(20,8,'#',1,0,'C',0);
        $this->Cell(38,8,'CLIENTE',1,0,'C',0);
        $this->Cell(60,8,'FECHA DE SOLICITUD',1,0,'C',0);
        $this->Cell(40,8,'MONTO',1,0,'C',0);
        $this->Cell(35,8,'ESTADO',1,1,'C',0);
...
else
{
    ...
    foreach($datos as $row)
    {
        ...
        $pdf->Cell(38,8,$row['cre_codigo'],1,0,'C',0);
        $pdf->Cell(60,8,$row['cre_fecha'],1,0,'C',0);
        $pdf->Cell(40,8,$row['cre_monto'],1,0,'C',0);
        $pdf->Cell(35,8,$row['cre_estado'],1,1,'C',0);
