...
<div class="full-box page-header">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="<?php echo SERVERURL; ?>reporte-clientes-financieros/?pagina=1"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
					</li>
					<li>
			...
			<div class="container-fluid">
				...
				<form action="<?php echo SERVERURL; ?>controladores/controladorRepclientes.php/">
