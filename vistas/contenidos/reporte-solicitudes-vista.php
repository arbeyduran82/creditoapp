 ...
 <div class="full-box page-header">
            ...
            <div class="container-fluid">
			    <ul class="full-box list-unstyled page-nav-tabs">
			        ...
			        <li>
			            <a class="active" href="<?php echo SERVERURL; ?>reporte-solicitudes/"><i class="far fa-calendar-alt"></i> &nbsp; SOLICITUDES</a>
			        </li>
                    <li>
                        <a  href="<?php echo SERVERURL; ?>reporte-creditos-aprobados/"><i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; APROBADOS</a>
                    </li>
			        <li>
             ...
             <div class="container-fluid">
                <div class="table-responsive">
                    ...
                    <form action="../controladores/controladorRepsolicitud.php/">
