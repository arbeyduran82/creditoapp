...
<?php
    require_once 'controladores/controladorpaginadorRepestado.php';
...
?>
 ...
 <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-tasks"></i> &nbsp; SOLICITUDES DE CREDITO
                </h3>
            </div>
            ...
            <div class="container-fluid">
			    <ul class="full-box list-unstyled page-nav-tabs">
			        ...
			        <li>
			            <a class="active" href="<?php echo SERVERURL; ?>reporte-solicitudes/?pagina=1"><i class="far fa-calendar-alt"></i> &nbsp; SOLICITUDES</a>
			        </li>
                    <li>
                        <a  href="<?php echo SERVERURL; ?>reporte-creditos-aprobados/?pagina=1"><i class="fas fa-hand-holding-usd fa-fw"></i> &nbsp; APROBADOS</a>
                    </li>
			        <li>
             ...
             <div class="container-fluid">
                <div class="table-responsive">
                    ...
                    <form action="<?php echo SERVERURL; ?>controladores/controladorRepsolicitud.php/">
