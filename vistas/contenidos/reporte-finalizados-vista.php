<!-- Page header -->
<?php
    require_once 'controladores/controladorpaginadorRepfinalizado.php';
...
<div class="full-box page-header">
			...
			<div class="container-fluid">
			    <ul class="full-box list-unstyled page-nav-tabs">
			        ...
			        <li>
			            <a class="active" href="<?php echo SERVERURL; ?>reporte-finalizados/?pagina=1"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; FINALIZADOS</a>
			        </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="table-responsive">
                    ...
                    <form action="<?php echo SERVERURL; ?>controladores/controladorRepfinalizados.php/">
