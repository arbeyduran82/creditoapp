 ...
 <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="far fa-calendar-alt fa-fw"></i> &nbsp; SOLICITUDES
                </h3>
            </div>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="<?php echo SERVERURL; ?>solicitud-solicitud/"><i class="far fa-calendar-alt"></i> &nbsp; RESERVACIONES</a>
                    </li>
                    <li>
                    ...
                    <table class="table table-dark table-sm">
                        ...
                        <tbody>
                            <tr class="text-center" >
                                ...
                                <td>2017/10/8</td>
                                <td>2017/10/10</td>
                                <td><span class="badge badge-warning">Solicitud</span></td>
