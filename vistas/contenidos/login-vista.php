	...
	<div class="login-content">
		...
		<form action="<?php echo SERVERURL?>controladores/usuarioControlador.php" method="POST">
			<div class="form-group">
				...
				<input type="text" class="form-control" name="txtusuario" pattern="[a-zA-Z0-9]{1,35,@}" maxlength="50">
			</div>
			<div class="form-group ">
				<label for="UserPassword" class="bmd-label-floating"><i class="fas fa-key"></i> &nbsp; Contraseña</label>
				<input type="password" class="form-control" name="txtpassword" pattern="[a-zA-Z0-9$@.-]{7,100}" maxlength="100">
			</div>
			...
			<div class="form-group">
				...
				<div class="row justify-content-center">
					<div class="col-md-10">
						<select class="form-control fadeIn third" name="txtrol">
