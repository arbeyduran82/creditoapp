...
<div class="container-fluid">
	...
	<form action="../controladores/actualizarCliControlador.php" method="POST"class="form-neon" autocomplete="off">
		<fieldset>
			...
			<div class="col-12 col-md-4">
				<div class="form-group">
					<label for="item_detalle" class="bmd-label-floating">DIRECCIÓN</label>
